...
//                 {/* Features */}
//                 <div className="grid md:grid-cols-3 gap-8 mt-20" style={{ perspective: 1000 }}>
//                   <motion.div
...
//                   >
//                     <div
//                       onClick={() => isLoggedIn && setCurrentPage('exercises')}
...
//                   >
//                     <div
//                       onClick={() => isLoggedIn && setCurrentPage('diet')}
//                       className={`bg-gray-800/50 backdrop-blur p-6 rounded-lg border border-gray-700 hover:border-red-500 transition-all h-full ${isLoggedIn ? 'cursor-pointer' : 'opacity-75'}`}
//                       style={{
//                         boxShadow: '0 10px 30px -10px rgba(0,0,0,0.5), 0 1px 3px rgba(0,0,0,0.3)',
//                         transformStyle: 'preserve-3d',
...
//                   >
//                     <div
//                       onClick={() => isLoggedIn && setCurrentPage('progress')}
//                       className={`bg-gray-800/50 backdrop-blur p-6 rounded-lg border border-gray-700 hover:border-red-500 transition-all h-full ${isLoggedIn ? 'cursor-pointer' : 'opacity-75'}`}
//                       style={{
//                         boxShadow: '0 10px 30px -10px rgba(0,0,0,0.5), 0 1px 3px rgba(0,0,0,0.3)',
//                         transformStyle: 'preserve-3d',
